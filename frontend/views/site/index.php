...
<head>
	...
	<script type="text/javascript">
		...
		function nmlogin(){
			var sd = {"type":"nmlogin"};
			 $.ajax({
				url: '<?= Yii::$app->urlManager->createUrl('site/nmlogin') ?>',
				type: 'POST',
				data: sd,
				dataType: "json",
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 sm col-sm-1 login" style="width: 500px;margin:0 auto;margin-top: 200px;">
				...
				<div style="width: 400px;margin:0 auto;height: 320px;">
					...
					<div style="position: absolute;bottom: 40px; width: 400px;text-align: center;">
						<input class="btn btn-primary btn-lg" type="button" value="匿名登录" onclick="nmlogin()" style="margin-left:20px;"/>
					</div>
				</div>
			</div>
			<div class="col-md-4 sm col-sm-1"></div>
