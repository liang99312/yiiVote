	...
	<script type="text/javascript">
		...
		function dlogin(){
			...
			var sd = {"type":"dlogin","dept":dept};
			 $.ajax({
				url: '<?= Yii::$app->urlManager->createUrl('site/dlogin') ?>',
				type: 'POST',
				data: sd,
				dataType: "json",
				...
				success: function (data) {
					if(data.msg === "success"){
						window.location.href='<?= Yii::$app->urlManager->createUrl('site/vote') ?>';
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 sm col-sm-1 login" style="width: 500px;margin:0 auto;margin-top: 200px;">
				...
				<div style="width: 240px;margin:0 auto;height: 290px;">
					<div style="position: absolute;bottom: 200px; width: 240px;text-align: center;">
						<label>部门：</label>
					...
					<div style="position: absolute;bottom: 40px; width: 240px;text-align: center;">
