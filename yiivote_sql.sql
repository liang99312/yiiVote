...
ALTER TABLE `yiivote`.`yii_vrecord` 
ADD COLUMN `p_id` INT(11) NOT NULL AFTER `yijian`;

ALTER TABLE `yiivote`.`yii_vresult` 
ADD COLUMN `p_id` INT(11) NOT NULL AFTER `zongf`;

/*201605012*/
ALTER TABLE `yiivote`.`yii_vuser` 
ADD COLUMN `u_zhiwu` varchar(225) NULL AFTER `u_code`;

ALTER TABLE `yiivote`.`yii_vuser` 
ADD COLUMN `u_zhiji` varchar(225) NULL AFTER `u_code`;

ALTER TABLE `yiivote`.`yii_vuser` 
ADD COLUMN `d_id` INT(11) NOT NULL AFTER `u_code`;
...
ALTER TABLE `yiivote`.`yii_vplan` 
ADD COLUMN `p_aflag` VARCHAR(32) NULL COMMENT '' AFTER `p_date`;

ALTER TABLE `yiivote`.`yii_vrecord` 
ADD COLUMN `d_id` INT(11) NOT NULL AFTER `yijian`;

ALTER TABLE `yiivote`.`yii_vresult` 
ADD COLUMN `d_id` INT(11) NOT NULL AFTER `zongf`;